...
namespace Code
{
    ...
    public class TestGenericMethods
    {
        public static void Main(string[] args)
        {
            ...
            emplist.Add(new Employee(1111, 250000, "Roy", Designations.CFO));

            emplist.Add(new Employee(0011, 12000000, "Gargi", Designations.CEO));

            emplist.Add(new Employee(2001, 501000, "Smit", Designations.sde));

            emplist.Add(new Employee(2004, 20999, "Milan", Designations.CEO));

            emplist.Add(new Employee(4001, 78000, "Riya", Designations.sde));

            emplist.Add(new Employee(6006, 900000, "Roshan", Designations.CFO));
